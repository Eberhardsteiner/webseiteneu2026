...
import imgEST from '../assets/EST.jpg';
import imgML from '../assets/ML.jpg';
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-[#101420]">
          {/* Portrait images as dark teal watermarks */}
          <img
            src={imgEST}
            alt=""
            aria-hidden="true"
            className="hero-portrait hero-portrait-left"
          />
          <img
            src={imgML}
            alt=""
            aria-hidden="true"
            className="hero-portrait hero-portrait-right"
          />
      ...
      <style>{`
        .hero-portrait {
          ...
          width: auto;
          object-fit: cover;
          filter: grayscale(1) brightness(0.35) contrast(1.4) sepia(1) hue-rotate(160deg) saturate(2.5);
          mix-blend-mode: screen;
          pointer-events: none;
          -webkit-mask-image: radial-gradient(ellipse 70% 80% at center, rgba(0,0,0,0.85) 20%, transparent 70%);
          mask-image: radial-gradient(ellipse 70% 80% at center, rgba(0,0,0,0.85) 20%, transparent 70%);
        }
        .hero-portrait-left {
          left: -5%;
          right: auto;
        ...
        @media (max-width: 768px) {
          .hero-portrait {
            height: 80%;
            filter: grayscale(1) brightness(0.25) contrast(1.4) sepia(1) hue-rotate(160deg) saturate(2.5);
          }
          .hero-portrait-left {
            left: -25%;
          }
