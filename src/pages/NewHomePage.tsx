...
import heroBackgroundImage from '../assets/ESTML3.jpg';
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-[#101420]">
          <div
            className={`absolute inset-x-0 bottom-0 overflow-hidden transition-[top] duration-300 ${
              scrolled ? 'top-[64px] md:top-[72px]' : 'top-[72px] md:top-[80px]'
            }`}
          >
            <img
