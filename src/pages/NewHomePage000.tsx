    ...
    <div className="min-h-screen bg-white">
      ...
      <style>{`
        .hero-portrait {
          ...
          width: auto;
          object-fit: cover;
          filter: grayscale(1) brightness(0.55) contrast(1.3) sepia(1) hue-rotate(160deg) saturate(2);
          mix-blend-mode: screen;
          pointer-events: none;
          -webkit-mask-image: radial-gradient(ellipse 70% 80% at center, rgba(0,0,0,0.9) 20%, transparent 70%);
          mask-image: radial-gradient(ellipse 70% 80% at center, rgba(0,0,0,0.9) 20%, transparent 70%);
        }
        .hero-portrait-left {
          left: -5%;
        }
        ...
        @media (max-width: 768px) {
          .hero-portrait {
            height: 80%;
            filter: grayscale(1) brightness(0.45) contrast(1.3) sepia(1) hue-rotate(160deg) saturate(2);
          }
          .hero-portrait-left {
            left: -25%;
          }
